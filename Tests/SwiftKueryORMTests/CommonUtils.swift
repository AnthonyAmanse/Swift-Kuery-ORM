...
class TestConnection: Connection {
    ...
    private func returnResult(_ onCompletion: @escaping ((QueryResult) -> ())) {
        ...
        case .returnThreeRowsSortedAscending:
            onCompletion(.resultSet(ResultSet(TestResultFetcher(numberOfRows: 3, sortedBy: "ascending"))))
        case .returnThreeRowsSortedDescending:
            onCompletion(.resultSet(ResultSet(TestResultFetcher(numberOfRows: 3, sortedBy: "descending"))))
        case .returnError:
...
class TestResultFetcher: ResultFetcher {
    ...
    init(numberOfRows: Int, sortedBy: String? = nil) {
